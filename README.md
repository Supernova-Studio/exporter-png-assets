<img src="https://github.com/Supernova-Studio/exporter-png-assets/blob/main/readme-icon.png?raw=true" alt="Supernova Logo" style="max-width:100%;">
...
The PNG Asset exporter allows you to **export a list of images** in such a way that it can be immediately used in your production codebase. This specific exporter exports assets in generic fashion, as 1x, 2x and 3x PNG format. 
